...
class Model(object):
    ...
    def build(self,
        ...
        # XXX
        print "----------------"
        print word_lstm_for.link(inputs)
        print "----------------"
        # XXX
        ...
        # XXX
        print "----------------"
        print word_for_output[0]
        print "----------------"
        print word_for_output[1]
        print "----------------"
        print word_for_output[2]
        print "----------------"
        # XXX
        ...
        # XXX: me
        # theano.printing.debugprint(final_output)
        # XXX: me
